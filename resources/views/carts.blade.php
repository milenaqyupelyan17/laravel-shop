    ...
    <div class="row align-items-start flex gap-20">
        ...
        <section id="cart-table" style="width: 80%;">
            <div class="wrapper">
                    ...
                    <div style="overflow-x:auto;">
                        <table style="width:100%; border-collapse:collapse;">
                            ...
                            <tbody>
                                    ...
                                    <td style="padding:20px 10px;">
                                        <div class="flex align-items-center gap-20">
                                            <img src="{{ asset($item->product->image) }}" alt="{{ $item->product->title }}"
                                                style=" width:70px; height:130px; object-fit:cover;">
                                            <div>
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="flex flex-column align-items-center justify-content-center gap-20 text-center">
                                            <div class="title-4">
                                                No orders yet
                                            </div>
                ...
                <div id="empty-cart" class="wrapper text-center flex flex-column  gap-20 align-items-center"
                    style="display:none;">
